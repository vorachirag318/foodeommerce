...
/// @nodoc
class __$$UiSuccessCopyWithImpl<T, $Res> extends _$UiResultCopyWithImpl<T, $Res>
    implements _$$UiSuccessCopyWith<T, $Res> {
  __$$UiSuccessCopyWithImpl(
      _$UiSuccess<T> _value, $Res Function(_$UiSuccess<T>) _then)
      : super(_value, (v) => _then(v as _$UiSuccess<T>));

  @override
  _$UiSuccess<T> get _value => super._value as _$UiSuccess<T>;
...
/// @nodoc
class __$$UiFailureCopyWithImpl<T, $Res> extends _$UiResultCopyWithImpl<T, $Res>
    implements _$$UiFailureCopyWith<T, $Res> {
  __$$UiFailureCopyWithImpl(
      _$UiFailure<T> _value, $Res Function(_$UiFailure<T>) _then)
      : super(_value, (v) => _then(v as _$UiFailure<T>));

  @override
  _$UiFailure<T> get _value => super._value as _$UiFailure<T>;
